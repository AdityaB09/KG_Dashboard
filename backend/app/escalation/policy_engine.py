...
class EscalationPolicyEngine:
        ...
        if isinstance(configured, dict):
            for key, value in configured.items():
                try:
                    ...
                    continue
        return max(0.0, float(getattr(settings, "ESCALATION_RESPONSE_WINDOW_SECONDS", 0)))
    ...
    def public_summary(self) -> dict[str, Any]:
        ...
        return {
            ...
            "responseTierProfile": policy.get("responseTierProfile") or {},
            "referenceAutomationExamples": policy.get("referenceAutomationExamples") or {},
