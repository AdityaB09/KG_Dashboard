...
_ENV_KEYS: dict[EscalationLevel, tuple[str, ...]] = {
    EscalationLevel.CARE_TEAM_REVIEW: ("ESCALATION_EMAIL_T1", "ESCALATION_EMAIL_CARE_TEAM", "ESCALATION_EMAIL_L1"),
    EscalationLevel.URGENT_PROVIDER_REVIEW: ("ESCALATION_EMAIL_T2", "ESCALATION_EMAIL_URGENT_PROVIDER", "ESCALATION_EMAIL_L2"),
    EscalationLevel.RAPID_RESPONSE_ACTIVATION: ("ESCALATION_EMAIL_T3", "ESCALATION_EMAIL_RRT", "ESCALATION_EMAIL_L3"),
    EscalationLevel.CODE_RESPONSE_ACTIVATION: ("ESCALATION_EMAIL_E", "ESCALATION_EMAIL_CODE", "ESCALATION_EMAIL_L4"),
}
