...
AVAILABLE_MODELS: dict[str, str] = {
    # Top ten models from the dashboard benchmark results, ordered by preference.
...
def main() -> None:
    ...
    output_file = (
        ...
        / f"SLM_Response_{output_key}_DASHBOARD_WIDGET_TOP10_V3.json"
    )

    print("=" * 80)
    print("PHASE 7 OLLAMA — ARRHYTHMIA DASHBOARD WIDGET TOP 10 V3")
    print("=" * 80)
    ...
    try:
        ...
        saved_result = {
            ...
            "validationMode": "widget_top10_v3_with_deterministic_fact_overlay",
            "caseMode": CASE_MODE,
