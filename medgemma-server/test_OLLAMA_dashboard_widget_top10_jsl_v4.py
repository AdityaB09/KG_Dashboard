...
OUTPUT_SCHEMA_VERSION = "phase-7-widget-interpretation-v4"
...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "The script can pull the selected model before inference and remove "
            "it from Ollama after the run."
        )
    )
...
def main() -> None:
    ...
    output_file = (
        ...
        / f"SLM_Response_{output_key}_DASHBOARD_WIDGET_JSL_V4.json"
    )

    print("=" * 80)
    print("PHASE 7 OLLAMA — ARRHYTHMIA DASHBOARD WIDGET TOP 10 + JSL V4")
    print("=" * 80)
    ...
    try:
        ...
        saved_result = {
            ...
            "validationMode": "widget_top10_jsl_v4_with_deterministic_fact_overlay",
