...
MODEL_SPECS: dict[str, dict[str, Any]] = {
    # -------------------------------------------------------------------------
    # Current top ten benchmark models
    # -------------------------------------------------------------------------
    "huatuo7": {
        ...
        "parameters": "7B",
        "quantization": "Q5_K_M",
        "approximateDiskGB": 5.0,
        "recommendedContext": 16384,
        "dashboardRole": "Primary natural-language arrhythmia interpretation",
        "licenseNote": "Review the upstream model license before deployment.",
    },
    "q8": {
        ...
        "parameters": "4B",
        "quantization": "Q8_0",
        "approximateDiskGB": 4.5,
        "recommendedContext": 16384,
        "dashboardRole": "Primary fallback and concise medical summary",
        "licenseNote": "Review Google Health AI model terms before deployment.",
    },
    "huatuo8": {
        "model": "hf.co/QuantFactory/HuatuoGPT-o1-8B-GGUF:Q5_K_M",
        "group": "top10",
        "family": "HuatuoGPT-o1",
        "parameters": "8B",
        "quantization": "Q5_K_M",
        "approximateDiskGB": 5.8,
        "recommendedContext": 16384,
        "dashboardRole": "Secondary medical-reasoning comparison",
        "licenseNote": "Review the upstream model license before deployment.",
    },
    "medical_qwen25": {
        "model": "hf.co/mradermacher/Medical-Qwen2.5-7B-Instruct-GGUF:Q4_K_M",
        "group": "top10",
        "family": "Medical Qwen 2.5",
        "parameters": "7B",
        "quantization": "Q4_K_M",
        "approximateDiskGB": 4.7,
        "recommendedContext": 16384,
        "dashboardRole": "Structured JSON and cautious reasoning comparison",
        "licenseNote": "Review the upstream model license before deployment.",
    },
    "openbiollm_q5": {
        ...
        "parameters": "8B",
        "quantization": "Q5_K_M",
        "approximateDiskGB": 5.7,
        "recommendedContext": 16384,
        "dashboardRole": "Conservative biomedical fallback",
        "licenseNote": "Review the upstream model license before deployment.",
    },
    "openbiollm": {
        "model": "charlestang06/openbiollm",
        "group": "top10",
        "family": "OpenBioLLM",
        "parameters": "8B class",
        "quantization": "Repository default",
        "approximateDiskGB": None,
        "recommendedContext": 16384,
        "dashboardRole": "Secondary OpenBioLLM comparison",
        "licenseNote": "Review the Ollama repository and upstream license.",
    },
    "bf16": {
        ...
        "parameters": "4B",
        "quantization": "BF16",
        "approximateDiskGB": 8.0,
        "recommendedContext": 16384,
        "dashboardRole": "Higher-precision MedGemma comparison; heavy on 14 GB RAM",
        "licenseNote": "Review Google Health AI model terms before deployment.",
    },
    "med_qwen2": {
        ...
        "approximateDiskGB": 4.5,
        "recommendedContext": 16384,
        "dashboardRole": "Medical Qwen comparison",
        "licenseNote": "Review the upstream model license before deployment.",
    },
    "llama31": {
        "model": "llama3.1:8b",
        ...
        "approximateDiskGB": 4.9,
        "recommendedContext": 16384,
        "dashboardRole": "General-model baseline",
        "licenseNote": "Review the Meta Llama license before deployment.",
    },
    "mistral_nemo": {
        ...
        "parameters": "12B",
        "quantization": "Q4_K_M",
        "approximateDiskGB": 7.1,
        "recommendedContext": 16384,
        "dashboardRole": "Larger general-model baseline; slow on CPU-only systems",
        "licenseNote": "Review the Mistral model license before deployment.",
    },

    # -------------------------------------------------------------------------
    # Additional John Snow Labs medical models requested for comparison
    # These models are NOT yet ranked against the existing top ten.
    # Their upstream licenses are generally CC-BY-NC-ND and are not suitable
    # for commercial deployment without confirming the applicable terms.
    # -------------------------------------------------------------------------
    "jsl_med_sft_llama3_8b": {
        "model": "hf.co/mradermacher/JSL-Med-Sft-Llama-3-8B-GGUF:Q4_K_M",
        "group": "jsl",
        "family": "JSL-Med-Sft-Llama-3",
        "parameters": "8B",
        "quantization": "Q4_K_M",
        "approximateDiskGB": 5.0,
        "recommendedContext": 16384,
        "dashboardRole": "JSL clinical summarization and medical reasoning benchmark",
        "licenseNote": "CC-BY-NC-ND 4.0 / John Snow Labs acceptable-use terms; verify before use.",
    },
    "jsl_medllama3_v2": {
        "model": "hf.co/mradermacher/JSL-MedLlama-3-8B-v2.0-GGUF:Q4_K_M",
        "group": "jsl",
        "family": "JSL-MedLlama-3 v2.0",
        "parameters": "8B",
        "quantization": "Q4_K_M",
        "approximateDiskGB": 5.0,
        "recommendedContext": 16384,
        "dashboardRole": "JSL medical chat and natural-language interpretation benchmark",
        "licenseNote": "CC-BY-NC-ND 4.0 / John Snow Labs acceptable-use terms; verify before use.",
    },
    "jsl_medmnx7_v2": {
        "model": "hf.co/mradermacher/JSL-MedMNX-7B-v2.0-GGUF:Q4_K_M",
        "group": "jsl",
        "family": "JSL-MedMNX v2.0",
        "parameters": "7B",
        "quantization": "Q4_K_M",
        "approximateDiskGB": 4.5,
        "recommendedContext": 16384,
        "dashboardRole": "JSL biomedical reasoning and root-cause hypothesis benchmark",
        "licenseNote": "CC-BY-NC-ND 4.0 / John Snow Labs acceptable-use terms; verify before use.",
    },
    "jsl_medphi35_mini_v3": {
        "model": "hf.co/mradermacher/JSL-Med-Phi-3.5-Mini-v3-GGUF:Q4_K_M",
        "group": "jsl",
        "family": "JSL-Med Phi-3.5 Mini v3",
        "parameters": "4B",
        "quantization": "Q4_K_M",
        "approximateDiskGB": 2.39,
        "recommendedContext": 16384,
        "recommendedMaxTokens": 3500,
        "minimumSystemRamGB": 8,
        "recommendedSystemRamGB": 12,
        "dashboardRole": "Lightweight JSL option for CPU testing",
        "licenseNote": "Review John Snow Labs and upstream Phi-3.5 license terms before use.",
    },

    # -------------------------------------------------------------------------
    # Heavy medical models requested for deeper benchmark comparison.
    # These are approximately 12-13.5 GB model files before KV cache, runtime
    # buffers, the operating system, and Ollama overhead are added. A computer
    # with 24 GB RAM is the practical minimum; 32 GB is strongly preferred.
    # -------------------------------------------------------------------------
    "jsl_med_sft_llama3_8b_q8": {
        "model": "hf.co/mradermacher/JSL-Med-Sft-Llama-3-8B-GGUF:Q8_0",
        "group": "jsl_high_quality",
        "family": "JSL-Med-Sft-Llama-3",
        "parameters": "8B",
        "quantization": "Q8_0",
        "approximateDiskGB": 8.6,
        "recommendedContext": 16384,
        "recommendedMaxTokens": 3000,
        "minimumSystemRamGB": 14,
        "recommendedSystemRamGB": 18,
        "dashboardRole": "Higher-quality official JSL 8B quant for narrative comparison",
        "licenseNote": "CC-BY-NC-ND 4.0 / John Snow Labs acceptable-use terms; verify before use.",
    },
    "jsl_medllama3_v2_q8": {
        "model": "hf.co/mradermacher/JSL-MedLlama-3-8B-v2.0-GGUF:Q8_0",
        "group": "jsl_high_quality",
        "family": "JSL-MedLlama-3 v2.0",
        "parameters": "8B",
        "quantization": "Q8_0",
        ...
        "minimumSystemRamGB": 14,
        "recommendedSystemRamGB": 18,
        "dashboardRole": "Higher-quality official JSL medical chat and interpretation benchmark",
        "licenseNote": "CC-BY-NC-ND 4.0 / John Snow Labs acceptable-use terms; verify before use.",
    },
    "jsl_medmnx7_v2_q8": {
        "model": "hf.co/mradermacher/JSL-MedMNX-7B-v2.0-GGUF:Q8_0",
        "group": "jsl_high_quality",
        "family": "JSL-MedMNX v2.0",
        "parameters": "7B",
        "quantization": "Q8_0",
        "approximateDiskGB": 7.8,
        "recommendedContext": 16384,
        "recommendedMaxTokens": 3000,
        "minimumSystemRamGB": 13,
        "recommendedSystemRamGB": 16,
        "dashboardRole": "Higher-quality official JSL biomedical reasoning benchmark",
        "licenseNote": "CC-BY-NC-ND 4.0 / John Snow Labs acceptable-use terms; verify before use.",
    },

    "jsl_medqwen14_reasoning_q6": {
        "model": "hf.co/mradermacher/JSL-MedQwen-14b-reasoning-GGUF:Q6_K",
        "group": "heavy_jsl",
        "family": "JSL-MedQwen Reasoning",
        "parameters": "14B",
        "quantization": "Q6_K",
        "approximateDiskGB": 12.2,
        "recommendedContext": 12288,
        "recommendedMaxTokens": 2500,
        "minimumSystemRamGB": 20,
        "recommendedSystemRamGB": 24,
        "dashboardRole": "Primary heavy JSL medical-reasoning benchmark for root-cause narratives",
        "licenseNote": "Verify the upstream JSL/derivative license and acceptable-use terms before deployment.",
    },
    "mediqwen_reasoning14_q6": {
        "model": "hf.co/mradermacher/MediQwen-Reasoning-14B-GGUF:Q6_K",
        "group": "heavy_medical",
        "family": "MediQwen Reasoning",
        "parameters": "14B",
        "quantization": "Q6_K",
        "approximateDiskGB": 12.2,
        "recommendedContext": 12288,
        ...
        "minimumSystemRamGB": 20,
        "recommendedSystemRamGB": 24,
        "dashboardRole": "Heavy medical reasoning comparison for ranked possible contributors",
        "licenseNote": "Apache-2.0 is reported for the quantized repository; verify the complete upstream chain.",
    },
    "cure_med14_q6": {
        "model": "hf.co/mradermacher/CURE-MED-14B-GGUF:Q6_K",
        "group": "heavy_medical",
        "family": "CURE-MED",
        "parameters": "14B",
        "quantization": "Q6_K",
        "approximateDiskGB": 12.1,
        "recommendedContext": 12288,
        "recommendedMaxTokens": 2500,
        "minimumSystemRamGB": 20,
        "recommendedSystemRamGB": 24,
        "dashboardRole": "Multilingual healthcare reasoning and structured dashboard comparison",
        "licenseNote": "Apache-2.0 is reported for the quantized repository; verify the upstream model card.",
    },
    "medicaledi14_reasoning_q6": {
        "model": "hf.co/mradermacher/MedicalEDI-14b-EDI-Reasoning-Final-I-GGUF:Q6_K",
        "group": "heavy_medical",
        "family": "MedicalEDI Reasoning",
        "parameters": "14B",
        "quantization": "Q6_K",
        "approximateDiskGB": 12.2,
        "recommendedContext": 12288,
        ...
        "minimumSystemRamGB": 20,
        "recommendedSystemRamGB": 24,
        "dashboardRole": "Heavy evidence-differentiation and uncertainty-reasoning benchmark",
        "licenseNote": "Review the upstream model license and dataset terms before deployment.",
    },
    "medgemma27_text_q3s": {
        "model": "hf.co/mradermacher/medgemma-27b-text-it-GGUF:Q3_K_S",
        "group": "heavy_medical",
        "family": "MedGemma 27B Text IT",
        "parameters": "27B",
        "quantization": "Q3_K_S",
        "approximateDiskGB": 12.2,
        "recommendedContext": 12288,
        "recommendedMaxTokens": 2200,
        "minimumSystemRamGB": 22,
        "recommendedSystemRamGB": 32,
        "dashboardRole": "Largest text-only MedGemma benchmark for medical narrative quality",
        "licenseNote": "Google Health AI Developer Foundations terms apply; review before deployment.",
    },
    "medgemma27_it_q3s": {
        "model": "hf.co/mradermacher/medgemma-27b-it-GGUF:Q3_K_S",
        "group": "heavy_medical",
        "family": "MedGemma 27B IT",
        "parameters": "27B",
        "quantization": "Q3_K_S",
        "approximateDiskGB": 12.3,
        "recommendedContext": 12288,
        "recommendedMaxTokens": 2200,
        "minimumSystemRamGB": 22,
        "recommendedSystemRamGB": 32,
        "dashboardRole": "Large multimodal-trained MedGemma benchmark used here with text evidence only",
        "licenseNote": "Google Health AI Developer Foundations terms apply; review before deployment.",
    },
    "qwen25_14b_instruct_q6": {
        "model": "hf.co/mradermacher/Qwen2.5-14B-Instruct-GGUF:Q6_K",
        "group": "heavy_control",
        ...
        "minimumSystemRamGB": 20,
        "recommendedSystemRamGB": 24,
        "dashboardRole": "Strong structured-JSON control model; not medically specialized",
        "licenseNote": "Apache-2.0; this is a general model and must not be treated as medically validated.",
    },
}

AVAILABLE_MODELS: dict[str, str] = {
    alias: str(spec["model"]) for alias, spec in MODEL_SPECS.items()
}

# FLAN-T5 is included here as a sizing/reference catalog, not as a selectable
# dashboard model. The current evidence prompt is roughly 7,000+ tokens while
# common FLAN-T5 checkpoints are designed around a much shorter 512-token input
# length. They are also general instruction models rather than medical models.
# Even though llama.cpp supports FLAN-T5 and GGUF conversions exist, adding one
# to AVAILABLE_MODELS would make this particular benchmark truncate most of the
# ECG + FHIR evidence and would therefore create misleading comparisons.
FLAN_T5_REFERENCE_SPECS: dict[str, dict[str, Any]] = {
    "flan_t5_small": {
        "parameters": "77M",
        "nativeInputTokens": 512,
        "fp32WeightsApproxGB": 0.31,
        "q4WeightsApproxGB": 0.05,
        "fitOnThisComputer": "Very light, but far too small and short-context for this dashboard prompt.",
    },
    "flan_t5_base": {
        "parameters": "0.2B",
        "nativeInputTokens": 512,
        "fp32WeightsApproxGB": 1.0,
        "q4WeightsApproxGB": 0.157,
        "fitOnThisComputer": "Very light, but not recommended for clinical root-cause JSON generation.",
    },
    "flan_t5_large": {
        "parameters": "0.8B",
        "nativeInputTokens": 512,
        "fp32WeightsApproxGB": 3.1,
        "q4WeightsApproxGB": 0.487,
        "fitOnThisComputer": "Fits easily, but the short input limit makes it unsuitable for the current package.",
    },
    "flan_t5_xl": {
        "parameters": "3B",
        "nativeInputTokens": 512,
        "fp16WeightsApproxGB": 6.0,
        "q4WeightsApproxGB": 1.5,
        "fitOnThisComputer": "Weights can fit when quantized, but CPU inference and the short context remain poor fits.",
    },
    "flan_t5_xxl": {
        "parameters": "11B",
        "nativeInputTokens": 512,
        "fp16WeightsApproxGB": 20.5,
        "int8WeightsApproxGB": 10.25,
        "q4WeightsApproxGB": 5.12,
        "fitOnThisComputer": "Only a low-bit quant may fit in 13.8 GB RAM; expected to be slow and still short-context.",
    },
}
...
OUTPUT_SCHEMA_VERSION = "phase-7-widget-interpretation-heavy-v5"
...
def print_model_catalog() -> None:
    ...
    for alias, spec in MODEL_SPECS.items():
        size = spec.get("approximateDiskGB")
        size_text = "unknown" if size is None else f"~{size} GB"
        print(
            f"{alias:32} | {spec.get('group', ''):13} | "
            f"{spec.get('parameters', ''):8} | {spec.get('quantization', ''):12} | "
            f"{size_text:10} | {spec.get('model')}"
        )
        print(f"  Role: {spec.get('dashboardRole', '')}")
        if spec.get("minimumSystemRamGB") or spec.get("recommendedSystemRamGB"):
            print(
                "  RAM: minimum "
                f"{spec.get('minimumSystemRamGB', 'unknown')} GB; recommended "
                f"{spec.get('recommendedSystemRamGB', 'unknown')} GB"
            )
        print(
            f"  Suggested run: context={spec.get('recommendedContext', DEFAULT_CONTEXT_SIZE)}, "
            f"max_tokens={spec.get('recommendedMaxTokens', DEFAULT_MAX_OUTPUT_TOKENS)}"
        )
        print(f"  License: {spec.get('licenseNote', '')}")
    print()
    print("FLAN-T5 REFERENCE SIZING — NOT SELECTABLE FOR THIS LONG-INPUT BENCHMARK")
    print("=" * 120)
    for alias, spec in FLAN_T5_REFERENCE_SPECS.items():
        print(f"{alias:20} | {spec}")


def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run one selected Ollama model for a synthetic unified ECG + FHIR "
            "arrhythmia dashboard-widget benchmark using SLM_Input_Package.json. "
            "The catalog includes the existing top models, JSL models, and heavy "
            "12-13 GB medical models. The script can pull the selected model before "
            "inference and remove it from Ollama after the run."
        )
    )
    ...
    parser.add_argument(
        ...
        help="Model alias from MODEL_SPECS.",
    )
    parser.add_argument(
        "--model-name",
        default=None,
        help="Exact Ollama model name. Overrides the model name behind --model.",
    )
    parser.add_argument(
        "--list-models",
        action="store_true",
        help="Print runnable model specifications and FLAN-T5 reference sizes, then exit.",
    )
    parser.add_argument(
        "--pull-model",
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Pull the selected Ollama model when it is missing. Default: enabled.",
    )
    parser.add_argument(
        "--remove-after-run",
        action=argparse.BooleanOptionalAction,
        default=False,
        help=(
            "After success or failure, stop and remove the selected model from "
            "Ollama. Default: disabled. Use this explicitly when disk cleanup is desired."
        ),
    )
    parser.add_argument(
        "--context",
...
def total_system_memory_gb() -> float | None:
    """Best-effort total physical RAM detection without third-party packages."""
    try:
...
def print_memory_preflight(model_spec: dict[str, Any], context_size: int) -> None:
    actual_ram = total_system_memory_gb()
    model_size = model_spec.get("approximateDiskGB")
    minimum_ram = model_spec.get("minimumSystemRamGB")
    recommended_ram = model_spec.get("recommendedSystemRamGB")

    print("=" * 80)
    print("LOCAL MEMORY PREFLIGHT")
    print("=" * 80)
    if actual_ram is None:
        print("System RAM could not be detected automatically.")
    else:
        print(f"Detected physical RAM: {actual_ram:.1f} GB")
    print(f"Model file size estimate: {model_size if model_size is not None else 'unknown'} GB")
    print(f"Requested context: {context_size} tokens")
    if minimum_ram:
        print(f"Model-spec minimum RAM: {minimum_ram} GB")
    if recommended_ram:
        print(f"Model-spec recommended RAM: {recommended_ram} GB")

    if actual_ram is not None and minimum_ram and actual_ram < float(minimum_ram):
        print(
            "WARNING: This machine is below the model-spec minimum RAM. The model "
            "may fail to load, use Windows page file heavily, or run extremely slowly."
        )
    elif actual_ram is not None and model_size and actual_ram < float(model_size) + 4.0:
        print(
            "WARNING: Model weights leave less than about 4 GB for Ollama, KV cache, "
            "Python, and Windows. Loading may fail even though the file fits on disk."
        )
    else:
        print("Memory estimate is not an immediate hard-stop, but runtime overhead still varies.")
    print()
...
def find_ollama_cli() -> str:
    ...
    if not executable:
        raise RuntimeError(
            "The Ollama CLI was not found in PATH. Install Ollama or add ollama.exe "
            "to PATH before using automatic pull/remove operations."
        )
    return executable


def run_ollama_cli(arguments: list[str], check: bool = True) -> subprocess.CompletedProcess[str]:
    executable = find_ollama_cli()
    ...
    try:
        ...
        raise RuntimeError(
            f"Ollama command failed with exit code {exc.returncode}: "
            f"{' '.join(command)}"
        ) from exc
...
def ensure_model_available(model_name: str, pull_model: bool) -> bool:
    """Return True when the model was already installed before this run."""
    was_installed = is_model_installed(model_name)
    if was_installed:
        print(f"Model is already installed: {model_name}")
        return True

    if not pull_model:
        raise RuntimeError(
            f"Model is not installed: {model_name}. Re-run with --pull-model or "
            f"manually run: ollama pull {model_name}"
        )

    print()
    print("=" * 80)
    print("PULLING SELECTED OLLAMA MODEL")
    print("=" * 80)
    run_ollama_cli(["pull", model_name])

    if not is_model_installed(model_name):
        raise RuntimeError(
            f"Ollama pull completed but the model is still not discoverable: {model_name}"
        )
    return False


def remove_model_from_ollama(model_name: str) -> None:
    print()
    print("=" * 80)
    print("STOPPING AND REMOVING SELECTED OLLAMA MODEL")
    print("=" * 80)
    executable = find_ollama_cli()
    subprocess.run(
    ...
    if result.returncode != 0:
        detail = (result.stderr or result.stdout or "unknown Ollama error").strip()
        print(f"Warning: model removal failed for {model_name}: {detail}")
    else:
        print(f"Removed model from Ollama storage: {model_name}")
...
def main() -> None:
    ...
    output_file = (
        ...
        / f"SLM_Response_{output_key}_HEAVY_MEDICAL_WIDGET_V5.json"
    )

    print("=" * 80)
    print("PHASE 7 OLLAMA — ARRHYTHMIA DASHBOARD WIDGET + HEAVY MEDICAL/JSL V5")
    print("=" * 80)
    print(f"Input file: {INPUT_FILE.name}")
    print(f"Selected alias: {selected_alias}")
    model_spec = copy.deepcopy(MODEL_SPECS[selected_alias])
    model_spec["model"] = model_name

    print(f"Model name: {model_name}")
    print(f"Model group: {model_spec.get('group')}")
    print(f"Model family: {model_spec.get('family')}")
    print(f"Parameters: {model_spec.get('parameters')}")
    print(f"Quantization: {model_spec.get('quantization')}")
    print(f"Approximate model size: {model_spec.get('approximateDiskGB')} GB")
    print(f"Recommended context: {model_spec.get('recommendedContext', DEFAULT_CONTEXT_SIZE)}")
    print(f"Recommended max output tokens: {model_spec.get('recommendedMaxTokens', DEFAULT_MAX_OUTPUT_TOKENS)}")
    print(f"Minimum system RAM: {model_spec.get('minimumSystemRamGB', 'not specified')} GB")
    print(f"Recommended system RAM: {model_spec.get('recommendedSystemRamGB', 'not specified')} GB")
    print(f"Context size: {args.context}")
    print(f"Initial output tokens: {args.max_tokens}")
    print(f"Output file: {output_file.name}")
    print(f"Case mode: {CASE_MODE}")
    print(f"Automatic pull: {args.pull_model}")
    print(f"Remove after run: {args.remove_after_run}")
    print()
    print_memory_preflight(model_spec, args.context)

    model_was_installed_before = False
    try:
        model_was_installed_before = ensure_model_available(
            model_name,
        ...
        saved_result = {
            ...
            "validationMode": "heavy_medical_jsl_v5_with_deterministic_fact_overlay",
            "modelSpecification": model_spec,
            "modelWasInstalledBeforeRun": model_was_installed_before,
            "caseMode": CASE_MODE,
        ...
        if args.remove_after_run:
            try:
                remove_model_from_ollama(model_name)
