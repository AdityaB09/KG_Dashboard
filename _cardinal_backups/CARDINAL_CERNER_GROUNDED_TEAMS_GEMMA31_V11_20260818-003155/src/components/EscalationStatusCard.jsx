...
const PATHWAY_DISPLAY = {
  MONITOR_ONLY: { short: "MONITOR", severity: "monitor" },
  CARE_TEAM_REVIEW: { short: "CARE TEAM", severity: "care" },
  URGENT_PROVIDER_REVIEW: { short: "PROVIDER", severity: "provider" },
  RAPID_RESPONSE_ACTIVATION: { short: "RRT", severity: "rrt" },
  CODE_RESPONSE_ACTIVATION: { short: "CODE", severity: "code" },
  // Legacy stored cases before backend canonicalization.
  L0_MONITOR: { short: "MONITOR", severity: "monitor" },
  L1_NURSING_REVIEW: { short: "CARE TEAM", severity: "care" },
  L2_URGENT_PROVIDER_REVIEW: { short: "PROVIDER", severity: "provider" },
  L3_RAPID_RESPONSE_REVIEW: { short: "RRT", severity: "rrt" },
  L4_EMERGENCY_RESPONSE: { short: "CODE", severity: "code" },
};
