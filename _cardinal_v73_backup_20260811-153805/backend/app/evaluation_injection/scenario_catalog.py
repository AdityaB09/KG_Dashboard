...
SCENARIO_FALLBACKS: dict[str, dict[str, Any]] = {
    ...
    "WCT-DIFF-009": {
        "display": "Wide-complex tachycardia",
        "shortLabel": "Wide-complex tachycardia",
        "symbol": "WCT",
        "category": "wide_complex_tachycardia",
    },
    "WPW-AFIB-010": {
        "display": "Irregular wide-complex tachycardia",
        "shortLabel": "Pre-excited AF",
        "symbol": "WPW-AF",
        "category": "preexcited_atrial_fibrillation",
    },
    "FLUTTER-IC-011": {
        "display": "Regular wide-complex tachycardia",
        "shortLabel": "Atrial flutter / WCT",
        "symbol": "AFL",
        "category": "atrial_flutter_wide_complex",
    },
    "PERI-STEMI-012": {
        "display": "ST elevation detected",
        "shortLabel": "ST elevation",
        "symbol": "ST",
        "category": "st_elevation",
    },
    "BRASH-013": {
        "display": "Junctional bradycardia with hemodynamic compromise",
        "shortLabel": "BRASH pattern",
        "symbol": "BRASH",
        "category": "junctional_bradycardia",
    },
    "AMIO-DDI-014": {
        "display": "Sinus bradycardia with prolonged QTc",
        "shortLabel": "Bradycardia / prolonged QT",
        "symbol": "SB",
        "category": "sinus_bradycardia_prolonged_qt",
    },
}
