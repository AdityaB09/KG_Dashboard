...
const evaluationWidgetResult =
  ...
  const displayedSlmWidgetResult =
    useMemo(() => {
      ...
      // V7 already returns the complete nine-field model interpretation and
      // intentionally does not use the old evaluator/Phase-6 presentation.
      // Do not inject legacy score/safety cards into the V7 clinical widget.
      if (
        slmWidgetResult?.provenance?.pipeline ===
          "etiology_v7" ||
        slmWidgetResult?.widgetInterpretation?.schemaVersion ===
